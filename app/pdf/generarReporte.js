...
module.exports = {
    generarDirectorio(Scouts) {
        ...
        for(var i = 0; i < Scouts.length; i++){
            ...
            console.log("PATRULLA: "+ JSON.stringify({ text: '' + Scouts[i].dataValues.fechanacimiento.getDate() + '/' + (Scouts[i].dataValues.fechanacimiento.getMonth() + 1) + '/' + Scouts[i].dataValues.fechanacimiento.getFullYear() + ''}));
            rows.push([ 
                {
